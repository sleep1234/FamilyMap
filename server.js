...
app.use((req, res, next) => {
  ...
  res.set('Content-Security-Policy',
    "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://webapi.amap.com https://restapi.amap.com; img-src 'self' data: https://*.is.autonavi.com; style-src 'self' 'unsafe-inline'; connect-src 'self' https://restapi.amap.com wss: ws:");
  next();
});
